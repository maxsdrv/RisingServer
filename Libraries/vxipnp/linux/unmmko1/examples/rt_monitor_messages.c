...
int main() {
    ...
    // Настраиваем все оконечные устройства
    unmkocheck(unmmko1_rt_configure(session, 0xffffffffu, UNMMKO1_RT_TRANSFORM | UNMMKO1_RT_BUS_A_AND_B | UNMMKO1_RT_DEFAULT_RESPONSES));
